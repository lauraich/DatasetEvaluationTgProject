...
from sklearn.utils import check_random_state, as_float_array, check_scalar

from sklearn.neighbors import kneighbors_graph, NearestNeighbors
from sklearn.manifold import spectral_embedding
from sklearn.cluster._kmeans import k_means

from SklearnAlgorithms.PairwiseDegree import pairwise_kernels
...
class SpectralClustering(ClusterMixin, BaseEstimator):
    ...
    def fit(self, X, y=None, metric="minkowski"):
        ...
        if self.affinity == "nearest_neighbors":
            connectivity = kneighbors_graph(
                X, n_neighbors=self.n_neighbors, include_self=True, n_jobs=self.n_jobs, metric=metric
            )
