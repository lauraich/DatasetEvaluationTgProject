...
def _kmeans_plusplus(X, n_clusters, x_squared_norms, random_state, n_local_trials=None):
    ...
    closest_dist_sq = cosine_distances(centers[0, np.newaxis],X, isunidimensional=False)
    ...
    for c in range(1, n_clusters):
        ...
        # Compute distances to center candidatess
        distance_to_candidates = cosine_distances(X[candidate_ids],X, isunidimensional=False)
...
def _kmeans_single_elkan(
    ...
    center_half_distances = cosine_distances(centers) / 2
    ...
    for i in range(max_iter):
        ...
        center_half_distances = cosine_distances(centers_new) / 2
